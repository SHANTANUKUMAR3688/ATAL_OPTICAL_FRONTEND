...
function Register() {
  ...
  return (
    <div className="flex items-center justify-center bg-gradient-to-r from-slate-300 via-slate-500 to-slate-300 h-screen">
      <div className="mb-4 mt-4 flex max-w-5xl flex-col sm:mx-2 xl:flex-row">
        ...
        <div className="w-full bg-white shadow-2xl xl:w-auto xl:rounded-bl-2xl xl:rounded-tl-2xl">
          <div className="mx-7 mt-4 pb-1 mb-4 rounded-xl bg-white shadow-2xl">
            <div className="m-10">
              ...
              <button
                ...
                className="mt-4 rounded-md bg-red-500 px-6 py-2 text-xl font-semibold text-white hover:bg-red-600 hover:shadow-lg active:bg-red-700 active:shadow-lg hover:rounded-full transition duration-200 ease-in-out ml-16 hover:cursor-pointer"
              >
                Register
              </button>
            </div>
